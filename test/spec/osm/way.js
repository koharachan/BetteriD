describe('iD.osmWay', function() {
    ...
    describe('#segments', function() {
        it('returns each way segment', function() {
            ...
            // each segment's extent must be its own two nodes, not the way's
            // first two nodes (regression: arrow function in `segments` bound
            // `this` to the osmWay, so the crossing_ways validator could not
            // detect crossings beyond the first segment - upstream iD #12731)
    ...
    describe('#sidednessIdentifier', function() {
        it('returns tag when the tag has implied sidedness', function() {
            ...
            expect(new iD.osmWay({tags: { man_made: 'quay' }}).sidednessIdentifier()).toEqual('man_made');
